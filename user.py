...
def update_user(name, data=None):
    ...
    user_name = name
    user_info = data
    ret = {"success": True, "message": "success!", "user_name": user_name, "id": user_info["id"],
           "avatar_url": user_info["avatar_url"], "user_url": user_info["html_url"], "user_type": user_info["type"],
           "company": user_info["company"], "public_repo_number": user_info["public_repos"],
           "follower_number": user_info["followers"],
           "created_at": user_info["created_at"][0:10] + ' ' + user_info["created_at"][11:19],
           "updated_at": user_info["updated_at"][0:10] + ' ' + user_info["updated_at"][11:19]}
    time = datetime.now()
